...
$config['mongo_db']['default']['database'] = 'my_first';
...
$config['mongo_db']['new_db']['no_auth'] = TRUE;
$config['mongo_db']['new_db']['hostname'] = 'localhost';
$config['mongo_db']['new_db']['port'] = '27017';
$config['mongo_db']['new_db']['username'] = '';
$config['mongo_db']['new_db']['password'] = '';
$config['mongo_db']['new_db']['database'] = 'my_first';
$config['mongo_db']['new_db']['db_debug'] = TRUE;
$config['mongo_db']['new_db']['return_as'] = 'array';
$config['mongo_db']['new_db']['write_concerns'] = (int)1;
$config['mongo_db']['new_db']['journal'] = TRUE;
$config['mongo_db']['new_db']['read_preference'] = NULL;
$config['mongo_db']['new_db']['read_preference_tags'] = NULL;
